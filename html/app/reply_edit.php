...
<html lang="jp">
    ...
    <body>
        <form action="./reply_update.php" method="POST" enctype="multipart/form-data">
        ...
        <div>
            <table>
                ...
                <tr>
                    <td colspan="2"><textarea name="message" value="" rows="7" cols="50"><?php echo htmlspecialchars($request['message']); ?></textarea></td>
                </tr>
