...
/*
$sql = "INSERT INTO replies (board_id, name, subject, color, message, image_path, email, url, delete_key, create_at) 
SELECT boards.id, boards.name, boards.subject, boards.color, boards.message, boards.image_path, boards.email, boards.url, boards.delete_key, boards.create_at
FROM boards
JOIN replies ON boards.id = replies.board_id;";
*/
/*
$sql = "INSERT INTO replies (board_id, name, subject, color, message, image_path, email, url, delete_key, create_at) 
SELECT b.id, b.name, b.subject, b.color, b.message, b.image_path, b.email, b.url, b.delete_key, b.create_at
FROM boards b
JOIN replies r ON b.id = r.board_id";
*/
